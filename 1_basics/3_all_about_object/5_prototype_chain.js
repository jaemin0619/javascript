...
console.log(yuJin3.hasOwnProperty('sayHello')); //상속받은 property다.
...
function IdolModel4(name,year){
    ...
    this.year=year;
    this.sayHello=function(){
        return '안녕하세요 저는 instance 매서드입니다.';
    }
}
 ...
 * 
 * 인스터스의 __proto__ 변경 vs 함수의 prototype 변경
 */
...
//FemaleIdolModel 과 ray 와의 관계가 끊김
